...
#ifndef DB_MULTI_ROCKS_DB_H_
#define DB_MULTI_ROCKS_DB_H_
...
class MultiRocksDB: public DB
{
	std::vector<rocksdb::DB*> dbs;
	rocksdb::WriteOptions wo;
	rocksdb::ReadOptions ro;
public:
	MultiRocksDB(const std::map<std::string, std::string>& props, const std::string& dbDir);
	~MultiRocksDB();
	///
